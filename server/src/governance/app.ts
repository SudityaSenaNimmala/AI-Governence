...
import policyPacksRouter from "./routes/policyPacks.js";
import policySimulatorRouter from "./routes/policySimulator.js";
import euAiActRouter from "./routes/euAiAct.js";
...
governanceRouter.use("/api/policy-packs", policyPacksRouter);
governanceRouter.use("/api/policy-simulator", policySimulatorRouter);
governanceRouter.use("/api/eu-ai-act", euAiActRouter);
...
governanceRouter.use("/api/aws", awsRouter);
