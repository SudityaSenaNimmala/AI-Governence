import { CircleX, Clock, Sparkles, Trash2 } from "lucide-react";
...
export const InVoiceFileUploadNew = ({
  ...
  const getFileType = (file) => {
    ...
    if (file.type === "application/pdf" || fileExtension === ".pdf") {
      ...
      return fileExtension === ".jpeg" ? "JPEG" : "JPG";
  ...
  const addVendorWithInvoice = async (file) => {
    ...
    setIsDataExtractionUsingAIComplete(false);
    setExtractedData({});
    let res = await saveVendorWithInvoice(file, fileType);
    if (res.status === "OK") {
          ...
          {!isFileUploading ? (
            ...
            >
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  if (!e.currentTarget.style.borderColor.includes("#3b82f6")) {
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      Upload or paste from clipboard (PDF, JPG, PNG)
                    </p>
                    <p
                      style={{
                        fontSize: "12px",
                    ...
                    >
                      Supported formats: PDF, JPG, PNG (Max: 1MB for PDF, 5MB
                      for images)
                    </p>
                  </div>
                </div>
                ...
                <>
                  ...
                  >
                    <TextInput
                      ...
                      autoFocus={true}
                      inputWidth="calc(100% - 0px)"
                      defaultValue={extractedData?.vendor?.adminEmail}
