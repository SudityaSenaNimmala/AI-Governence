        ...
        <ul className="CF_TEAM_BREAD_CRUMBS">
          ...
          >
            <div className="breadCrumbs-Div">
              ...
              <span className="breadCrumbName">Content Mapping</span>
              <span className="chevron">
                {/* <AiFillCaretRight className="CF_TEAM_Chevron_Icon" /> */}
              </span>
            </div>
          ...
          >
            <div className="breadCrumbs-Div">
              ...
              <span className="breadCrumbName">Preview</span>
              <span className="chevron">
                {/* <AiFillCaretRight className="CF_TEAM_Chevron_Icon" /> */}
              </span>
            </div>
          ...
          <li
            className={`${teamMigration.atPosition === 6 ? "breadCrumbeActive" : ""
              }${teamMigration.atPosition > 6 ? "breadCrumbeActive-Completed" : ""
              }`}
          >
            <div className="breadCrumbs-Div">
              {/* <span className="CF_TEAM_Chevron_Before">
              ...
              <span className="breadCrumbCount">6</span>
