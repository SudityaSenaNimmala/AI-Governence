...
const ContentPerMissionMapping = (props) => {
        ...
        >
          <span>
            ...
            {permissionList.length > 0
              ? permissionList[0]?.noOfMappedCloudPressent
              : 0}
          </span>
          <span>
            Matched :{" "}
            {permissionList.length > 0 ? permissionList[0]?.matched : 0}
          </span>
          <span>
            Unmatched :
            {permissionList.length > 0 ? permissionList[0]?.notMatched : 0}
          </span>
...
export default ContentPerMissionMapping;
