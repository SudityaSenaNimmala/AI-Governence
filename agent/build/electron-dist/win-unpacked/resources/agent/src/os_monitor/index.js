...
export class OsMonitor {
  ...
  start() {
    ...
    this.enforcer.on('block', (ev) => {
      ...
      console.log('@@CFAI-BLOCK ' + JSON.stringify(blockData));
      // UI (banner, popups, dialogs) is handled by the Electron main process
      // which reads @@CFAI-BLOCK and @@CFAI-BLOCKSTATE from stdout above.
      // No PS1 spawns needed here.
    });
    ...
    this.enforcer.on('blockstate', (ev) => {
      ...
      console.log('@@CFAI-BLOCKSTATE ' + JSON.stringify(data));
      // Banner is handled by Electron main.js reading @@CFAI-BLOCKSTATE from stdout
    });
